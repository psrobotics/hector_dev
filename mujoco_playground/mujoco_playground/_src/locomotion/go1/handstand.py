...
class Handstand(go1_base.Go1Env):
    ...
    def _post_init(self) -> None:
        ...
        self._handstand_pose = jp.array(self._mj_model.keyframe("handstand").qpos[7:])
    ...
    def _get_reward(
        ...
        return {
            ...
            "orientation": self._reward_orientation(forward, self._desired_forward_vec),
...
class Footstand(Handstand):
    ...
    def _post_init(self) -> None:
        ...
        self._handstand_pose = jp.array(self._mj_model.keyframe("footstand").qpos[7:])
