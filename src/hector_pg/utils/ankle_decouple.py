...
MOT_DIR = jp.array(
    [
        ...
        1,
        1,
        1,  # ori 1 1 -1 1 we'll not handle joint dir here
        1,
        1,
        1,
        1,
...
def obs_ik_qdq(
    ...
    qd3 = policy_q[KNEE_IDX]
    dd3 = policy_dq[KNEE_IDX]
    ...
    qd4 = policy_q[ANKLE_IDX]
    dd4 = policy_dq[ANKLE_IDX]
    ...
    low_q = low_q.at[ARM_SPEC].set(
        joint_dir[ARM_SPEC] * policy_q[ARM_SPEC] * gear_ratio_arm
    )
    low_dq = low_dq.at[ARM_SPEC].set(
        joint_dir[ARM_SPEC] * policy_dq[ARM_SPEC] * gear_ratio_arm
    )
